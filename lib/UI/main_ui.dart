...
import 'package:flutter_classifiedappclone/UI/Widgets/camera_screen.dart';
...
class _MainUIState extends State<MainUI> {
  ...
  late List<Product> trendingListItems;
  late List<Product> recommendListItems;
  late List<Product> dealsListItems;
  late double _height;
  late double _width;
          ...
          Opacity(
            ...
            child: Container(
              ...
              child: ListTile(
                ...
                title: Text("Jack"),
                subtitle: Text("jackisbusy@gmail.com",style: TextStyle(fontSize: 13),),
                trailing: Icon(
