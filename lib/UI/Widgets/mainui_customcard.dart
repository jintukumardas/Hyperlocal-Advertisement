...
class CustomCard extends StatelessWidget {
  ...
  CustomCard({required this.title, required this.price, required this.dateAdded, required this.category,
      required this.description, required this.image, required this.location});
